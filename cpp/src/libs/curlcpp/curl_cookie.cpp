...
void curl_cookie::erase() { this->easy.add<CURLOPT_COOKIELIST>("ALL"); }

// Implementation of flush method.
void curl_cookie::flush() { this->easy.add<CURLOPT_COOKIELIST>("FLUSH"); }
...
void curl_cookie::reload() { this->easy.add<CURLOPT_COOKIELIST>("RELOAD"); }
} // namespace curl
