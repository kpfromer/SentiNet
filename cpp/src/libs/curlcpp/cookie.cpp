...
curl::cookie::cookie(const string &name, const string &value,
                     const cookie_datetime &datetime, const string &path,
                     const string &domain, const bool secure) {
...
curl::cookie::cookie(const char *name, const char *value,
                     const cookie_datetime &datetime, const char *path,
                     const char *domain, const bool secure) {
...
curl::cookie *curl::cookie::set_secure(const unsigned int _secure) {
  if (_secure == 0) {
    ...
    throw curl_easy_exception("The security can be 0 (false) or 1 (true)",
                              __FUNCTION__);
  }
  return this;
}
...
curl::cookie *
curl::cookie::set_datetime(const cookie_datetime &_datetime) NOEXCEPT {
  this->datetime = _datetime;
  return this;
}

// Implementation of get_name method.
string curl::cookie::get_name() const NOEXCEPT { return this->name; }

// Implmentation of get_value method.
string curl::cookie::get_value() const NOEXCEPT { return this->value; }

// Implementation of get_path method.
string curl::cookie::get_path() const NOEXCEPT { return this->path; }

// Implementation of get_domain method.
string curl::cookie::get_domain() const NOEXCEPT { return this->domain; }

// Implementation of is_secure method.
bool curl::cookie::is_secure() const NOEXCEPT { return this->secure; }
...
string curl::cookie::get_formatted() NOEXCEPT {
  ...
  return "Set-Cookie: " + this->name + "=" + this->value +
         "; expires=" + this->datetime.get_formatted() +
