...
bool CurlUploader::ftp_get(const std::string &url, const std::string &filename){
  CURL *curl;
  CURLcode ret;
...
std::string CurlUploader::http_get(const std::string &url, const std::string &request) {
  CURL *curl;
  CURLcode ret;
  curl = curl_easy_init();
  if(curl) {
...
bool CurlUploader::post_file(const std::string &url, const std::string &filename){
