...
#define TRIGGER_CODE_BITS \
  (TRIGGER_CODE_BYTES *   \
   8)  // not portable TODO - make work with opperating system
...
#define PRINT_TIME(_s1, _tb, _s2)                                        \
  do {                                                                   \
    printf("%s%02d:%02d:%02d   %02d/%02d/%04d%s", _s1, (int)(_tb)->hour, \
           (int)(_tb)->minute, (int)(_tb)->second, (int)(_tb)->month,    \
           (int)(_tb)->day, (int)(_tb)->year, _s2);                      \
    fflush(stdout);                                                      \
  } while (0)
