...
private:
  ...
  virtual std::string request_file(const std::string &url_base,
                                   const std::string &file_endpoint) {
...
public:
  virtual bool upload(const std::string &url_base,
                      const std::string &file_path) {
    return upload_file(url_base, file_path);
  }

  virtual std::string request(const std::string &url_base,
