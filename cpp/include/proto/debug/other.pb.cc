...
class MessageThingDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<MessageThing>
      _instance;
...
::google::protobuf::internal::SCCInfo<0> scc_info_MessageThing =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsMessageThing}, {}};
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::debug::MessageThing, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::debug::MessageThing, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::debug::MessageThing, name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::debug::MessageThing, id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::debug::MessageThing, extra_),
  0,
  2,
  1,
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::debug::_MessageThing_default_instance_),
};

void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "proto/debug/other.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ::google::protobuf::Descriptor* MessageThing::descriptor() {
  ...
  return ::protobuf_proto_2fdebug_2fother_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const MessageThing& MessageThing::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_proto_2fdebug_2fother_2eproto::scc_info_MessageThing.base);
...
::google::protobuf::uint8* MessageThing::InternalSerializeWithCachedSizesToArray(
...
::google::protobuf::Metadata MessageThing::GetMetadata() const {
  protobuf_proto_2fdebug_2fother_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_proto_2fdebug_2fother_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::debug::MessageThing* Arena::CreateMaybeMessage< ::debug::MessageThing >(Arena* arena) {
