...
class MessageThingDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<MessageThing>
      _instance;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
    scc_info_MessageThing_proto_2fdebug_2fother_2eproto = {
        {ATOMIC_VAR_INIT(
             ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized),
         0, InitDefaultsscc_info_MessageThing_proto_2fdebug_2fother_2eproto},
        {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata
    file_level_metadata_proto_2fdebug_2fother_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const**
    file_level_enum_descriptors_proto_2fdebug_2fother_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const**
    file_level_service_descriptors_proto_2fdebug_2fother_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_proto_2fdebug_2fother_2eproto::offsets
...
const char descriptor_table_protodef_proto_2fdebug_2fother_2eproto
    [] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_proto_2fdebug_2fother_2eproto = {
        &descriptor_table_proto_2fdebug_2fother_2eproto_initialized,
        descriptor_table_protodef_proto_2fdebug_2fother_2eproto,
        "proto/debug/other.proto",
        89,
        &descriptor_table_proto_2fdebug_2fother_2eproto_once,
        descriptor_table_proto_2fdebug_2fother_2eproto_sccs,
        descriptor_table_proto_2fdebug_2fother_2eproto_deps,
        1,
        0,
        schemas,
        file_default_instances,
        TableStruct_proto_2fdebug_2fother_2eproto::offsets,
        file_level_metadata_proto_2fdebug_2fother_2eproto,
        1,
        file_level_enum_descriptors_proto_2fdebug_2fother_2eproto,
        file_level_service_descriptors_proto_2fdebug_2fother_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_proto_2fdebug_2fother_2eproto =
...
const char* MessageThing::_InternalParse(
...
void MessageThing::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const MessageThing* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<MessageThing>(&from);
  if (source == nullptr) {
...
template <>
PROTOBUF_NOINLINE ::debug::MessageThing*
