...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fcommon_2fcmd_5fvel_2eproto;
namespace movement {
class camera;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::movement::camera* Arena::CreateMaybeMessage<::movement::camera>(Arena*);
template<> ::movement::drive_train* Arena::CreateMaybeMessage<::movement::drive_train>(Arena*);
...
class drive_train :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:movement.drive_train) */ {
 public:
  drive_train();
  virtual ~drive_train();

  drive_train(const drive_train& from);
  drive_train(drive_train&& from) noexcept
    : drive_train() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(drive_train& a, drive_train& b) {
    a.Swap(&b);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_proto_2fcommon_2fcmd_5fvel_2eproto);
    return ::descriptor_table_proto_2fcommon_2fcmd_5fvel_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
class camera :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:movement.camera) */ {
 public:
  camera();
  virtual ~camera();
...
class gun :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:movement.gun) */ {
 public:
  gun();
  virtual ~gun();

  gun(const gun& from);
  gun(gun&& from) noexcept
    : gun() {
    *this = ::std::move(from);
  }
  ...
  static inline const gun* internal_default_instance() {
    return reinterpret_cast<const gun*>(
               &_gun_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(gun& a, gun& b) {
    a.Swap(&b);
  }
  ...
  inline gun* New() const final {
    return CreateMaybeMessage<gun>(nullptr);
  }
