...
// Kelvin includes
//#include "applications/AzureEventHubUploader/AzureEventHubUploader.h"
#include "TestUtils.hpp"

/** The bare minimum required to make sure an application is able to compile and link.
 */
TEST(AzureEventHubUploaderTest, CompileAndLink) {
  // auto app = std::make_unique<AzureEventHubUploader::AzureEventHubUploader>();
}
