...
Curlloader::Curlloader(const std::string& destination_url, const std::string& output_path)
{
	destination = destination_url;
	ftpfile = new FtpFile;
...
size_t Curlloader::file_write(void* buffer, size_t size, size_t nmemb, void* stream)
{
