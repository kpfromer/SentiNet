...
PeripheralInterface::PeripheralInterface(ConfigurationClient& config, std::string name){
...
virtual void PeripheralInterface::set_immutables(ConfigurationClient& config, const unsigned int id){
...
//getters
virtual std::string Peripheral::get_name() const {
  return asset_name;
}
