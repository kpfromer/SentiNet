...
{
  public:
    PublisherInterface(ConfigurationClient& config, unsigned int id, rclcpp::Node::SharedPtr * node);
...
class RosInputInterface : public rclcpp::Node, public ControlClientInterface {
  public:
  ...
  private:
    std::map<std::string, std::shared_ptr<rclcpp::PublisherBaseInterface>> publishers; 
}
