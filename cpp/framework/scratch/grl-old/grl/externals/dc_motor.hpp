...
{
  public:
    DC_Motor(const ConfigurationClient& config, const std::string&, const std::string&) 
    : OutputInterface(ConfigurationClient& config, const std::string&, const std::string&);
